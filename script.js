...
// Flat list of all shades across every palette
...
let galleryFilter = 'all'; // active gallery filter
...
function addShade(shade) {
  if (mixSelected.find(s => s.hex === shade.hex)) return; // no duplicates
